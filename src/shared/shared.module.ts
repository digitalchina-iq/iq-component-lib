...
@NgModule({
  //imports 导入
  imports: [RouterModule,CommonModule,FormsModule,ReactiveFormsModule,FileUploadModule,ColorPickerModule],

  //公开一些组件,这样其他模块只要导入该模块，就可以在其组件模板中使用到出的这些组件了。
  exports: [SHARED_PIPES,SHARED_DIRECTIVES,SHARED_COMPONENTS,RouterModule,CommonModule,FormsModule,ReactiveFormsModule,FileUploadModule],
